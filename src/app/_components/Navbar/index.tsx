      ...
      <div className="max-w-7xl mx-auto">
        <div className="sm:hidden relative px-16 py-4 ">
          <button
            ...
            className="md:hidden text-white relative w-8 h-8"
          >
            <span
              className={`block absolute w-8 h-0.5 bg-gray transform transition duration-300 ease-in-out ${
                menuOpen ? "rotate-45 top-3.5" : "top-2"
              }`}
            ></span>
            <span
              className={`block absolute w-8 h-0.5 bg-gray transition-opacity duration-300 ease-in-out ${
